...
void poly_Rq_mul_tDiTRU(poly *r, const poly *a, const poly *b, bool trinary_a){
  ...
  */
  ...
  for(i=0;i<N;i++)
  {
    ...
    // for(int i=0; i<N; i++)
    // {
    //   tmp3->coeffs[i] = mod3(2*tmp3->coeffs[i]); //for twistd dihedral group
    // }

    // printf("the minus of tmp3 is \n");
    // print_poly_values(tmp3);         
    ...
    // printf("tmp1: ");
    // print_poly_values(tmp1);
    // printf("tmp2: ");
    // print_poly_values(tmp2);
